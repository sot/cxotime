# -*- coding: utf-8 -*-
#
# cxotime documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'cxotime.tex', u'cxotime Documentation',
...
man_pages = [
    (master_doc, 'cxotime', u'cxotime Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'cxotime', u'cxotime Documentation',
   author, 'cxotime', 'One line description of project.',
   'Miscellaneous'),
]
